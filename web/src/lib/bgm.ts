...
const Gb4 = 369.99, G4 = 392.0, Ab4 = 415.30, A4 = 440.0, Bb4 = 466.16, B4 = 493.88;
const C5 = 523.25, D5 = 587.33, Eb5 = 622.25, E5 = 659.25, F5 = 698.46, G5 = 783.99, A5 = 880.0;
const C3 = 130.81, D3 = 146.83, Eb3 = 155.56, E3 = 164.81, F3 = 174.61;
const G3 = 196.0, Ab3 = 207.65, A3 = 220.0, Bb3 = 233.08, B3 = 246.94;
...
const TRACKS: Record<string, TrackDef> = {
  ...
  ENDING: {
    ...
    // やる気のない帝国のマーチ
    melody: [
      [G4, 3], [REST, 1], [G4, 3], [REST, 1], [G4, 3], [REST, 1],
      [Eb4, 2], [REST, 1], [Bb4, 1], [G4, 3], [REST, 1],
      [Eb4, 2], [REST, 1], [Bb4, 1], [G4, 4], [REST, 2],

      [D5, 3], [REST, 1], [D5, 3], [REST, 1], [D5, 3], [REST, 1],
      [Eb5, 2], [REST, 1], [Bb4, 1], [Gb4, 3], [REST, 1],
      [Eb4, 2], [REST, 1], [Bb4, 1], [G4, 4], [REST, 2],
    ],
    bass: [
      [G3, 4], [G3, 4], [Eb3, 4], [Bb3, 2], [G3, 2],
      [G3, 4], [G3, 4], [Eb3, 4], [G3, 4],
    ],
  },
};
